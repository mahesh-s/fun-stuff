...
var OfflineUtility = function (onlineCallback, offlineCallback, pollingUrl) {
    ...
    // *** The following can be removed in production contexts *****
    // *************************************************************
    var debugCheckBoxId = '___forceOffline';
    // *************************************************************
    ...
    if (DEBUG_MODE) {
        var
            ...
            label = $('<label>Simulate Offline Mode</label>');
        ...
        container.attr('style', 'position:fixed;left:4px;bottom:4px;background-color:#eee;border:1px solid #ccc;padding:4px;font-family:Arial,Helvetica,sans-serif;font-size:0.7em;z-index:100000000;width:100px;text-align:center;');
